...
public class Medico extends Persona {
    ...
    public Medico(String matricula, String especialidad, int id, String dni, String apellido, String nombres, String direccion, String telefono, String email, Usuario usuario) {
