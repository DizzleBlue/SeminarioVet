...
<html>
    ...
    <body>
            ...
            <div class="container-fluid">
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a style="margin-left: 10px; border: none" class="btn btn-outline-light" href="ControladorMenu?menu=HistoriaClinica&accion=Listar" target="myFrame">Ingresar HC</a>
                        </li>
                        <li class="nav-item">
                            <a style="margin-left: 10px; border: none" class="btn btn-outline-light" href="ControladorMenu?menu=HistoriaClinica&accion=Nueva">Nueva HC</a>
                        </li>
                    </ul>
                    <div class="dropdown">
        ...
        <div class="m-4" style="height: 550px;">
            <iframe name="myFrame" src="historiaclinica.jsp" style="height: 100%; width: 100%; border: none">
